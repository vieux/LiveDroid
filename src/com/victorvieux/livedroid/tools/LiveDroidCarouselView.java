...
public class LiveDroidCarouselView extends CarouselView {

    public LiveDroidCarouselView(Context context, CarouselController controller) {
        this(context, null, controller);
    }

    public LiveDroidCarouselView(Context context, AttributeSet attrs) {
        this(context, attrs, new CarouselController());
    }

    public LiveDroidCarouselView(Context context, AttributeSet attrs, CarouselController controller) {
